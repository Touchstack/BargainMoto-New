...
const AboutMeetTheTeam = () => {
  return (
    <div className="container mx-auto lg:px-12">
      <h3 className="font-Bold text-[#191919] lg:text-4xl md:text-3xl sm:text-3xl text-3xl py-16 lg:text-left  text-center">
        Meet The Team
      </h3>
      <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 grid-cols-1 gap-8">
        <div className="px-4">
          ...
          />
          <p className="font-SemiBold text-[#191919] lg:text-2xl md:text-2xl sm:text-xl text-xl text-center pt-4">
            Andrew Berchie
          </p>
