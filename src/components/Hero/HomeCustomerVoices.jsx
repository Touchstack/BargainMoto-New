...
const HomeCustomerVoices = () => {
  return (
    <div className="bg-[#FFFDF6] py-40">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 relative gap-x-2 gap-y-16 px-4 pt-12 sm:pt-20 text-block text-[#191919]">
        <div className="bg-[#FDFCFB] rounded-lg shadow-2xl w-[304px] h-[257px] ml-64">
          <div className="font-Regular text-[#191919] text-lg mt-4 pl-4 pr-4">
            ...
            easy. I found a quality car that fits my budget. Highly recommend."
