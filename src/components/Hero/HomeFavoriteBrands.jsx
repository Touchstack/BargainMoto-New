...
const HomeFavoriteBrands = () => {
  return (
    <div
      className="container mx-auto text-[#191919] text-center lg:py-24 md:py-24 sm:py-16 py-24 md:px-4 px-11
       lg:p-32 md:p-24"
    >
      ...
      <div className="py-16">
        <div className="container mx-auto text-center text-dark">
          <div className="grid lg:grid-cols-5 md:grid-cols-5 sm:grid-cols-1 grid-cols-1 mt-5 gap-2 m-1">
            <div>
              <img
                src={Honda}
                alt="Honda-Logo"
