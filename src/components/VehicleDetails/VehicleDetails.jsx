...
const VehicleDetails = ({ vehicleData, loading }) => {
  ...
  return (
    <div className="bg-[#FBF8FC]">
      <div className="container mx-auto text-center lg:py-12 md:py-12 sm:py-6 py-6 md:px-12 px-11">
        <button
        ...
        {loading ? (
          <div className="font-Regular">Loading...</div>
        ) : vehicleData && !loading ? (
          <div className="mx-auto">
            <div className="flex lg:flex-row md:flex-col sm:flex-col flex-col">
              ...
              ></div>
              <div className="md:h-[500px] h-[350px] lg:w-3/12 lg:mr-4 mb-4">
              ...
              <div className="flex justify-center md:h-[500px] h-[300px] lg:w-3/12">
